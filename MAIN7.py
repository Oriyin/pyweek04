from utilities.calcu import add as add_def, subtract as subtract_def, multiply as multiply_def, divide as divide_def
from utilities.stringop import reverse_string, capitalize_string, lowercase_string, uppercase_string
print("Using calcu.py:")
